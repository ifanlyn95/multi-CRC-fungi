...
if (plot_or_not) {
  ...
  abline(v = median(bac_abd),
         ...
         lwd = 2,
         lty=2)
  text(median(bac_abd)*0.9, 150 , paste('median = ', round( median(bac_abd), 2)))
  ...
  abline(v = median(euk_abd), 
         ...
         lwd = 2,
         lty=2)
  text( median(euk_abd)*0.75, 200 , paste('median = ', round( median(euk_abd), 2)))
  ...
  abline(v = median(E_B_ratio),
         ...
         lwd = 2,
         lty=2)
  text( median(E_B_ratio)*1.4, 100 , paste('median = ', round( median(E_B_ratio), 2)))
