...
tax_df <- ImportTable(file = '../02.Filter_samples/Eukaryota_RawData_1636/2021-07-22-Selected-Euk_RawData-Species-v1.0.csv', sep = ',')
...
```{r meta information}
meta_df <- ImportTable(file = '../00.RawData/metaData/2021-07-20-metaInfo-subgroup_1636-v5.0.csv')
Show_table(meta_df)
```
