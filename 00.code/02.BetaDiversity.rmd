...
my_color <- c(ochre_palettes$namatjira_qual,
              ...
              ochre_palettes$nolan_ned[c(1:4)],
...
summary(aov(PCoA1 ~ Cohort, data = otu_pcoa_result))
summary(aov(PCoA1 ~ Continent, data = otu_pcoa_result))
wilcox.test(PCoA1 ~ Gender, data = otu_pcoa_result)
summary(aov(PCoA1 ~ Stage, data = otu_pcoa_result))

summary(aov(PCoA2 ~ Cohort, data = otu_pcoa_result))
summary(aov(PCoA2 ~ Continent, data = otu_pcoa_result))
wilcox.test(PCoA2 ~ Gender, data = otu_pcoa_result)
summary(aov(PCoA2 ~ Stage, data = otu_pcoa_result))
